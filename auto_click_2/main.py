...
class App(tk.Tk):
    def __init__(self):
        ...
        try:
            self.iconbitmap('auto_click_2/data_img/star.ico')
        except:
            pass
    ...
    def create_data(self):
        ...
        try:
            ...
            with open('auto_click_2/data_img/dados.json', 'r') as file:
                data = json.load(file)
        except:
            pass
    ...
    def on_close(self):
        ...
        with open('auto_click_2/data_img/dados.json', 'w') as file:
                json.dump(data, file)
        self.destroy()
